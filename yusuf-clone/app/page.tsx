...
export default function Home() {
  const perfumes = [
    ...
    { id: 'al-haroon', name: 'Al Harun V1', price: '2,990.00', image: '/products/al_haroon.png' },
    { id: 'latafa-khamrah', name: 'Lattafa Khamrah V1', price: '3,090.00', image: '/products/latafa_khamrah.png' },
    { id: 'almarziyah', name: 'Al Marziyah', price: '2,890.00', image: '/products/almarziyah.png' },
    { id: 'althair-vanilla', name: 'Althair vanilla', price: '2,790.00', image: '/products/althair_vanilla.png' },
    { id: 'delighted-dior', name: 'delighted dior', price: '2,690.00', image: '/products/delighted_dior_v2.png' },
  ...
  const perfumeOils = [
    ...
    { id: 'al-haroon', name: 'Al Harun V1', price: '710.00', image: '/products/al_haroon.png' },
    { id: 'latafa-khamrah', name: 'Lattafa Khamrah V1', price: '729.00', image: '/products/latafa_khamrah.png' },
    { id: 'almarziyah', name: 'Al Marziyah', price: '680.00', image: '/products/almarziyah.png' },
    { id: 'althair-vanilla', name: 'Althair vanilla', price: '629.00', image: '/products/althair_vanilla.png' },
    { id: 'delighted-dior', name: 'delighted dior', price: '579.00', image: '/products/delighted_dior_v2.png' },
