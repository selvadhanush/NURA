...
const PRODUCTS = [
  ...
  { id: 'delighted-dior-perfume', name: 'delighted dior', type: 'perfume', profiles: ['Sweet & Floral', 'Fresh & Citrus'], occasions: ['Everyday Wear', 'Professional Setting'], intensity: 'Long-lasting', price: '2,690.00', image: '/products/delighted_dior.png' },
  ...
  { id: 'delighted-dior-oil', name: 'delighted dior Oil', type: 'oil', profiles: ['Sweet & Floral', 'Fresh & Citrus'], occasions: ['Everyday Wear', 'Professional Setting'], intensity: 'Long-lasting', price: '579.00', image: '/products/delighted_dior.png' },
